...
const NavBar = () => {
  ...
  function handleSignout() {
    fetch('/signout')
      .then(res => res.json())
      .then(data => {
        console.log('Signout clicked: ', data)
      })
  }
      ...
      <div className="rightBtn">
        ...
        < Link to={{
          ...
          <button className="post">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
        ...
        < Link to={{
          ...
          <button className='textBtn version profile' onClick={() => handleSignout()}>
            Signout
          </button>
        </Link>
      </div>
